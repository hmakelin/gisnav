...
The :class:`.PoseEstimationNode`,  :class:`.BBoxNode`, and :class:`.MapNode` nodes are autopilot agnostic and are
launched from a shared description defined in this file.
"""
import os
...
from gisnav.nodes.base.camera_subscriber_node import ROS_CAMERA_INFO_TOPIC, ROS_IMAGE_TOPIC
...
def generate_launch_description():
    ...
    ld.add_action(Node(
        ...
        parameters=[os.path.join(package_share_dir, 'launch/params/pose_estimation_node.yaml')],
        remappings=[
