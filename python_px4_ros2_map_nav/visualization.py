...
class Visualization:
    ...
    def update(self, output_data: OutputData, vo_enabled: bool) -> None:
        ...
        out = np.vstack((self._map_visualization, self._vo_visualization, output_data._pose.image_pair.img.image.arr))
    ...
    def _create_visualization(output_data: OutputData, display_text: str) -> np.ndarray:
        ...
        ref_img = output_data._pose.image_pair.ref.image.arr
