...
class PoseEstimationNode(Node):
    ...
    def geopose_stamped_estimate(self) -> Optional[GeoPoseStamped]:
        ...
        ) -> Tuple[self.PoseEstimationInputs, _PoseEstimationIntermediateOutputs]:
