"""Launches :class:`.MockGPSNode` with the test_typhoon_h480__ksql_airport parameters"""
import os
...
def generate_launch_description():
    """Generates launch description with test_typhoon_h480__ksql_airport config file"""
