...
setup(
    name=package_name,
    version=version,
    packages=[package_name, package_name + '.keypoint_matchers', 'SuperGluePretrainedNetwork.models', 'LoFTR.src'],
    data_files=[
        ...
        (os.path.join('share', package_name, 'LoFTR', 'src'), glob('LoFTR/src/*.py', recursive=True)),
        (os.path.join('share', package_name, 'LoFTR', 'weights'), glob('LoFTR/weights/*.ckpt')),
        (os.path.join('share', package_name, 'LoFTR', 'src', 'loftr'), glob('LoFTR/src/loftr/*.py', recursive=True)),
        (os.path.join('share', package_name, 'LoFTR', 'src', 'loftr', 'backbone'),
         glob('LoFTR/src/loftr/backbone/*.py', recursive=True)),
        (os.path.join('share', package_name, 'LoFTR', 'src', 'loftr', 'utils'),
         glob('LoFTR/src/loftr/utils/*.py', recursive=True)),
        (os.path.join('share', package_name, 'LoFTR', 'src', 'loftr', 'loftr_module'),
         glob('LoFTR/src/loftr/loftr_module/*.py', recursive=True)),
